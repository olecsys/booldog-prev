				...
				namespace mbs
				{
						...
						, const char* name_or_path , const ::booldog::debug::info& debuginfo = debuginfo_macros )
					{
						...
						if( ::booldog::utils::string::mbs::towcs( &reswchar , allocator , name_or_path , 0 , SIZE_MAX
							, debuginfo ) )
							::booldog::utils::io::file::wcs::exists( res , allocator , reswchar.wchar , debuginfo );
						else
							res->copy( reswchar );
#else
						allocator = allocator;
				...
				namespace wcs
				{
						...
						, const wchar_t* name_or_path , const ::booldog::debug::info& debuginfo )
					{
						...
						if( ::booldog::utils::string::wcs::tombs( &resmbchar , allocator , name_or_path , 0 , SIZE_MAX 
							, debuginfo ) )
							::booldog::utils::io::file::mbs::exists( res , allocator , resmbchar.mbchar , debuginfo );
						else
							res->copy( resmbchar );
#endif
						return res->succeeded();
...
goto_return:
						...
						if( ::booldog::utils::string::wcs::tombs( &resmbchar , allocator , name_or_path , 0 , SIZE_MAX 
							, debuginfo ) )
							::booldog::utils::io::file::mbs::exists( res , allocator , resmbchar.mbchar , named_params
							, debuginfo );
						else
							res->copy( resmbchar );
#endif

		...
		namespace io
		{
			namespace file
			{
				namespace wcs
				{
					...
					booinline bool copyfile(::booldog::result* pres, ::booldog::allocator* allocator, const wchar_t* srcpathname
						, size_t srcpathname_length, const wchar_t* dstpathname, size_t dstpathname_length
						, const ::booldog::debug::info& debuginfo = debuginfo_macros);
					booinline bool remove(::booldog::result* pres, ::booldog::allocator* allocator, const wchar_t* pathname
						, size_t pathname_length, const ::booldog::debug::info& debuginfo = debuginfo_macros);
					booinline bool remove(::booldog::result* pres, ::booldog::allocator* allocator, const wchar_t* pathname
						, const ::booldog::debug::info& debuginfo = debuginfo_macros);
				};
				namespace mbs
				{
					booinline bool remove(::booldog::result* pres, ::booldog::allocator* allocator, const char* pathname
						, size_t pathname_length, const ::booldog::debug::info& debuginfo = debuginfo_macros)
					{
						...
						if(pathname_length == SIZE_MAX || pathname_length >= MAX_PATH)
						{
							...
							if(::booldog::utils::string::mbs::towcs(&wchar, allocator, pathname, 0, SIZE_MAX, debuginfo))
							{
								if(wchar.wlen >= MAX_PATH)
								{
									if(::booldog::utils::string::wcs::insert(res, allocator, false, 0, wchar.wchar, wchar.wlen
										, wchar.wsize, L"\\\\?\\", 0, SIZE_MAX, debuginfo) == false)
										return false;
									if(::booldog::utils::io::path::wcs::normalize(res, wchar.wchar, wchar.wlen, wchar.wsize) == false)
										return false;
								}
								return ::booldog::utils::io::file::wcs::remove(res, allocator, wchar.wchar, wchar.wlen, debuginfo);
							}
							else
							{
								res->copy(wchar);
					...
					booinline bool remove(::booldog::result* pres, ::booldog::allocator* allocator, const char* pathname
						, const ::booldog::debug::info& debuginfo = debuginfo_macros)
					{
						return ::booldog::utils::io::file::mbs::remove(pres, allocator, pathname, SIZE_MAX, debuginfo);
					}
					booinline bool copyfile(::booldog::result* pres, ::booldog::allocator* allocator, const char* srcpathname
						, size_t srcpathname_length, const char* dstpathname, size_t dstpathname_length
						, const ::booldog::debug::info& debuginfo = debuginfo_macros)
					{
						::booldog::result locres;
						BOOINIT_RESULT(::booldog::result);
						...
						{							
							...
							if(::booldog::utils::string::mbs::towcs(&srcwchar, allocator, srcpathname, 0, SIZE_MAX, debuginfo))
							{
								if(srcwchar.wlen >= MAX_PATH)
								{
									if(::booldog::utils::string::wcs::insert(res, allocator, false, 0, srcwchar.wchar, srcwchar.wlen
										, srcwchar.wsize, L"\\\\?\\", 0, SIZE_MAX, debuginfo) == false)
										return false;
									if(::booldog::utils::io::path::wcs::normalize(res, srcwchar.wchar, srcwchar.wlen, srcwchar.wsize) 
										== false)
										return false;
								}
								if(::booldog::utils::string::mbs::towcs(&dstwchar, allocator, dstpathname, 0, SIZE_MAX, debuginfo))
								{
									if(dstwchar.wlen >= MAX_PATH)
									{
										if(::booldog::utils::string::wcs::insert(res, allocator, false, 0, dstwchar.wchar, dstwchar.wlen
											, dstwchar.wsize, L"\\\\?\\", 0, SIZE_MAX, debuginfo) == false)
											return false;
										if(::booldog::utils::io::path::wcs::normalize(res, dstwchar.wchar, dstwchar.wlen
											, dstwchar.wsize) == false)
											return false;
									}
									return ::booldog::utils::io::file::wcs::copyfile(res, allocator, srcwchar.wchar, srcwchar.wlen
										, dstwchar.wchar, dstwchar.wlen, debuginfo);
								}
								else
								{
									res->copy(dstwchar);
						...
						if(srcfd != -1)
						{
							...
							if(dstfd != -1)
							{
								...
								{
#ifdef __LINUX__
									if(sendfile(dstfd, srcfd, 0, st.st_size) == -1)
#endif
									{
#ifdef __LINUX__
										int err = errno;
...
#endif
										{
											...
											{
												ssize_t size = 0;
												while((size = ::read(srcfd, data, datasize)) > 0)
												{
													if(::write(dstfd, data, size) == -1)
													{
														size = -1;
														break;
													}
						...
						, const char* name_or_path , const ::booldog::debug::info& debuginfo = debuginfo_macros )
					{
						...
						if(::booldog::utils::string::mbs::towcs(&reswchar, allocator, name_or_path, 0, SIZE_MAX, debuginfo))
							return ::booldog::utils::io::file::wcs::exists(res, allocator, reswchar.wchar, debuginfo);
						else
						{
							res->copy(reswchar);
							return false;
						...
						, const ::booldog::debug::info& debuginfo = debuginfo_macros )
					{
						...
						if( ::booldog::utils::string::mbs::towcs( &reswchar , allocator , name_or_path , 0 , SIZE_MAX 
							, debuginfo ) )
							::booldog::utils::io::file::wcs::exists( res , allocator , reswchar.wchar , named_params 
							, debuginfo );
						else
							res->copy( reswchar );
#else
						...
						{	
							...
							return ::booldog::utils::io::file::mbs::exists( res , allocator , res_name_or_path.mbchar 
								, debuginfo );
						}
						else
						{
							...
							if( settings[ 0 ].type != ::booldog::enums::param::type_not_found )
							{
									...
									!= ::booldog::enums::param::type_none ; index++ )
								{
									...
									if( ::booldog::utils::io::file::mbs::exists( res , allocator , res_root_dir.mbchar , 0
...
goto_return:
				...
				{
					booinline bool remove(::booldog::result* pres, ::booldog::allocator* allocator, const wchar_t* pathname
						, size_t pathname_length, const ::booldog::debug::info& debuginfo)
					{
						::booldog::result locres;
						BOOINIT_RESULT(::booldog::result);
#ifdef __WINDOWS__
						...
						if(pathname_length == SIZE_MAX || pathname_length >= MAX_PATH)
						{
							...
							if(::booldog::utils::string::wcs::insert(res, allocator, false, 0, wchar.wchar, wchar.wlen
								, wchar.wsize, L"\\\\?\\", 0, SIZE_MAX, debuginfo) == false)
								return false;
							if(::booldog::utils::string::wcs::insert(res, allocator, false, wchar.wlen, wchar.wchar
								, wchar.wlen, wchar.wsize, pathname, 0, SIZE_MAX, debuginfo) == false)
								return false;
							if(::booldog::utils::io::path::wcs::normalize(res, wchar.wchar, wchar.wlen, wchar.wsize) == false)
								return false;
					...
					{
						return ::booldog::utils::io::file::wcs::remove(pres, allocator, pathname, SIZE_MAX, debuginfo);
					}
					booinline bool copyfile(::booldog::result* pres, ::booldog::allocator* allocator, const wchar_t* srcpathname
						, size_t srcpathname_length, const wchar_t* dstpathname, size_t dstpathname_length
						, const ::booldog::debug::info& debuginfo)
					{
						...
						debuginfo = debuginfo;
						allocator = allocator;
						if(srcpathname_length == SIZE_MAX || dstpathname_length == SIZE_MAX || srcpathname_length >= MAX_PATH
							|| dstpathname_length >= MAX_PATH)
						{
							::booldog::results::wchar srcwchar(allocator), dstwchar(allocator);
							if(::booldog::utils::string::wcs::insert(res, allocator, false, 0, srcwchar.wchar, srcwchar.wlen
								, srcwchar.wsize, L"\\\\?\\", 0, SIZE_MAX, debuginfo) == false)
							...
							if(::booldog::utils::string::wcs::insert(res, allocator, false, 0, dstwchar.wchar, dstwchar.wlen
								, dstwchar.wsize, L"\\\\?\\", 0, SIZE_MAX, debuginfo) == false)
								return false;
							if(::booldog::utils::string::wcs::insert(res, allocator, false, srcwchar.wlen, srcwchar.wchar
								, srcwchar.wlen, srcwchar.wsize, srcpathname, 0, SIZE_MAX, debuginfo) == false)
								return false;
							if(::booldog::utils::io::path::wcs::normalize(res, srcwchar.wchar, srcwchar.wlen, srcwchar.wsize) == false)
								return false;
							if(::booldog::utils::string::wcs::insert(res, allocator, false, dstwchar.wlen, dstwchar.wchar
								, dstwchar.wlen, dstwchar.wsize, dstpathname, 0, SIZE_MAX, debuginfo) == false)
								return false;
							if(::booldog::utils::io::path::wcs::normalize(res, dstwchar.wchar, dstwchar.wlen, dstwchar.wsize) == false)
								return false;
						...
						, const wchar_t* name_or_path , const ::booldog::debug::info& debuginfo )
					{
						...
						if(::booldog::utils::string::wcs::tombs(resmbchar, name_or_path, 0, SIZE_MAX, debuginfo))
							return ::booldog::utils::io::file::mbs::exists(res, allocator, resmbchar.mbchar, debuginfo);
						else
						{
							res->copy(resmbchar);
							return false;
						...
						, ::booldog::named_param* named_params , const ::booldog::debug::info& debuginfo )
					{
						...
						if( resbool.bres )
						{
							...
							return ::booldog::utils::io::file::wcs::exists( res , allocator , res_name_or_path.wchar 
								, debuginfo );
						}
						else
						{
							...
							if( settings[ 0 ].type != ::booldog::enums::param::type_not_found )
							{
									...
									!= ::booldog::enums::param::type_none ; index++ )
								{
									...
									if( ::booldog::utils::io::file::wcs::exists( res , allocator , res_root_dir.wchar , 0 
										, debuginfo ) == false || res->bres )
										goto goto_return;
								}
							}
...
goto_return:
						...
						::booldog::result_mbchar resmbchar( allocator );
						if(::booldog::utils::string::wcs::tombs(resmbchar, name_or_path, 0, SIZE_MAX, debuginfo))
							::booldog::utils::io::file::mbs::exists(res, allocator, resmbchar.mbchar, named_params, debuginfo);
						else
							res->copy( resmbchar );
#endif
						return res->succeeded();

...
namespace booldog
{
	...
	namespace base
	{
		...
		public:
			...
			virtual bool init(::booldog::result* pres, booldog::allocator* allocator, void* initparams = 0
				, ::booldog::events::typedefs::onbeforefree ponafterinit = 0, void* udata = 0, bool function_abscence_is_error = true
				, const ::booldog::debug::info& debuginfo = debuginfo_macros )
			{
	...
	public:
		module()
			: _ref(1), _handle(0), _inited_ref(0), _udata(0), _prev(0)
		{
		}
		...
		virtual ::booldog::module_handle handle()
		{
			return _handle;
		};
		virtual void lock(const ::booldog::debug::info& debuginfo = debuginfo_macros)

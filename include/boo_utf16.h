...
namespace booldog
{
	namespace utf16
	{
//#define UNI_SUR_HIGH_START  (::booldog::uint32)0xD800
//#define UNI_SUR_HIGH_END    (::booldog::uint32)0xDBFF
//#define UNI_SUR_LOW_START   (::booldog::uint32)0xDC00
//#define UNI_SUR_LOW_END     (::booldog::uint32)0xDFFF
//#define UNI_REPLACEMENT_CHAR (::booldog::uint32)0x0000FFFD
//#define UNI_MAX_BMP (UTF32)0x0000FFFF
//#define UNI_MAX_UTF16 (UTF32)0x0010FFFF
//#define UNI_MAX_UTF32 (UTF32)0x7FFFFFFF
//#define UNI_MAX_LEGAL_UTF32 (::booldog::uint32)0x0010FFFF
		booinline bool isdigit( ::booldog::uint16 utfchar )
		{
		...
		booinline bool isalnum( ::booldog::uint16 utfchar )
		{
			return ( utfchar > 0x2f && utfchar < 0x3a )
		...
		booinline bool isalpha( ::booldog::uint16 utfchar )
		{
		...
		booinline ::booldog::enums::string::conversion_result to_utf8( const char* utf16_ptr , size_t& srcbyteindex
			, size_t utf16bytescount , char* utf8_ptr , size_t& dstbyteindex , size_t utf8allocsize , size_t& utf8_bytes 
			, size_t& utf8length )
		{
			const ::booldog::uint16* source = (::booldog::uint16*)(utf16_ptr + srcbyteindex)
				, * source_end = (::booldog::uint16*)(utf16_ptr + utf16bytescount);
			if(source_end < source)
				source_end = (::booldog::uint16*)SIZE_MAX;
			::booldog::uint8* target = (::booldog::uint8*)utf8_ptr + dstbyteindex
				, * target_end = (::booldog::uint8*)utf8_ptr + utf8allocsize;
			::booldog::uint32 ch = 0 , ch2 = 0;
			::booldog::byte diff = 0;
			if(utf8_ptr == 0)
			...
			while(source < source_end )
			{
				...
				if( ch >= (::booldog::uint32)0xD800 && ch <= (::booldog::uint32)0xDBFF ) 
				{
					...
					if( source < source_end ) 
					{
						...
						if( ch2 >= (::booldog::uint32)0xDC00 && ch2 <= (::booldog::uint32)0xDFFF ) 
						{
							ch = ( ( ch - (::booldog::uint32)0xD800 ) << 10 ) + ( ch2 - (::booldog::uint32)0xDC00 ) + 0x0010000UL;
							++source;
						}
						else
				...
				else
				{
					...
					if( ch >= (::booldog::uint32)0xDC00 && ch <= (::booldog::uint32)0xDFFF ) 
						return ::booldog::enums::string::conversion_result_sourceIllegal;
				}
				...
				else if( ch < (::booldog::uint32)0x110000 ) 
				{
					target += 4;
					if( target > target_end )
					{
			...
			srcbyteindex = ((char*)source - utf16_ptr);
...
goto_conversion_result_targetExhausted:
			...
			{
				utf8_bytes = (char*)target - utf8_ptr;
				srcbyteindex = ((char*)source - utf16_ptr) - 2;
		...
		booinline bool toutf8( ::booldog::result_mbchar* pres , booldog::allocator* allocator , const char* utf16
			, size_t& srcbyteindex , size_t utf16bytescount , const ::booldog::debug::info& debuginfo = debuginfo_macros )
		{
			...
			for( ; ; )
			{
				if( res->mbsize < utf8bytes + 1 )
				{
					res->mbsize = utf8bytes + 1;
				...
				convres = ::booldog::utf16::to_utf8( utf16 , srcbyteindex , utf16bytescount , res->mbchar , dstbyteindex , res->mbsize 
					, utf8bytes , res->mblen );
		...
		booinline bool toutf8(::booldog::result* pres, booldog::allocator* allocator, char*& dst, size_t& dstlen, size_t& dstsize
			, const char* utf16, size_t& srcbyteindex, size_t utf16bytescount
			, const ::booldog::debug::info& debuginfo = debuginfo_macros )
		{
			...
			for(;;)
			{
				...
				convres = ::booldog::utf16::to_utf8(utf16, srcbyteindex, utf16bytescount, dst, dstbyteindex, dstsize, utf8bytes
					, dstlen);
				if(convres == ::booldog::enums::string::conversion_result_sourceIllegal)
				{
					res->booerr(::booldog::enums::result::booerr_type_conversion_result_source_illegal);
		...
		{
			dst_bytes = 0;
			const ::booldog::uint16* source = (::booldog::uint16*)src_ptr , * source_end = (::booldog::uint16*)( src_ptr + src_ptr_count );
			::booldog::uint16* target = (::booldog::uint16*)dst_ptr , * target_end = (::booldog::uint16*)( dst_ptr + dst_ptr_count );
			::booldog::uint16 utfchar = 0;
			if( target == 0 )
				goto goto_conversion_result_targetExhausted;
			while( source < source_end )
			{
...
goto_conversion_result_targetExhausted:					
		...
		booinline ::booldog::enums::string::conversion_result to_cp1251( const char* utf16_ptr , size_t utf16_ptr_count , char* cp1251_ptr , size_t cp1251_ptr_count , size_t& cp1251_bytes )
		{
			cp1251_bytes = 0;
			const ::booldog::uint16* source = (::booldog::uint16*)utf16_ptr , * source_end = (::booldog::uint16*)( utf16_ptr + utf16_ptr_count );
			...
			while( source < source_end )
			{
				...
				else
				{
					...
					{
						*target = ::booldog::consts::utf16::_utf16_to_cp1251_page_from_152_to_187[ *source++ - 152 ];
						if( *target++ == 0 )
							return ::booldog::enums::string::conversion_result_sourceIllegal;
					}
					else if( *source > 1024 && *source < 1170 )
					{
						*target = ::booldog::consts::utf16::_utf16_to_cp1251_page_from_1025_to_1169[ *source++ - 1025 ];
						if( *target++ == 0 )
							return ::booldog::enums::string::conversion_result_sourceIllegal;
					}
					else if( *source > 8210 && *source < 8483 )
					{
						*target = ::booldog::consts::utf16::_utf16_to_cp1251_page_from_8211_to_8482[ *source++ - 8211 ];
						if( *target++ == 0 )
							return ::booldog::enums::string::conversion_result_sourceIllegal;
					}
					else
...
goto_conversion_result_targetExhausted:
			...
			while( source < source_end )
			{
				...
				else
				{
					if( *source > 151 && *source < 188 )
					{
						if( ::booldog::consts::utf16::_utf16_to_cp1251_page_from_152_to_187[ *source++ - 152 ] == 0 )
							return ::booldog::enums::string::conversion_result_sourceIllegal;
						else
							cp1251_bytes++;
					}
					...
					{
						if( ::booldog::consts::utf16::_utf16_to_cp1251_page_from_1025_to_1169[ *source++ - 1025 ] == 0 )
							return ::booldog::enums::string::conversion_result_sourceIllegal;
						else
							cp1251_bytes++;
					}
					...
					{
						if( ::booldog::consts::utf16::_utf16_to_cp1251_page_from_8211_to_8482[ *source++ - 8211 ] == 0 )
							return ::booldog::enums::string::conversion_result_sourceIllegal;
						else
							cp1251_bytes++;
					}
		...
		booinline ::booldog::enums::string::conversion_result to_utf32( const char* utf16_ptr , size_t utf16_ptr_count , char* utf32_ptr , size_t utf32_ptr_count , size_t& utf32_bytes )
		{
			utf32_bytes = 0;
			const ::booldog::uint16* source = (::booldog::uint16*)utf16_ptr , * source_end = (::booldog::uint16*)( &utf16_ptr[ utf16_ptr_count - 1 ] + 1 );
			::booldog::uint32* target = (::booldog::uint32*)utf32_ptr , * target_end = 0;
			if( utf32_ptr )
				target_end = (::booldog::uint32*)( &utf32_ptr[ utf32_ptr_count - 1 ] + 1 );
			::booldog::uint32 ch = 0 , ch2 = 0;
			while( source < source_end )
			{
				ch = *source++;

...
goto_conversion_result_targetExhausted:
		...
		template< size_t step >
		booinline bool toutf8(::booldog::result_mbchar& pres, const char* utf16, size_t& srcbyteindex, size_t utf16bytescount
			, const ::booldog::debug::info& debuginfo = debuginfo_macros)
		{
			::booldog::result res;
			if(::booldog::utf16::toutf8< step >(&res, pres.mballocator, pres.mbchar, pres.mblen, pres.mbsize, utf16
				, srcbyteindex, utf16bytescount, debuginfo))
				return true;
			else
			{
				pres.copy(res);

...
//#define UNI_MAX_LEGAL_UTF32 (::booldog::uint32)0x0010FFFF
		...
		booinline ::booldog::enums::string::conversion_result to_utf8( const char* utf16_ptr , size_t& srcbyteindex , size_t utf16_ptr_count , char* utf8_ptr , size_t& dstbyteindex , size_t utf8_ptr_count , size_t& utf8_bytes , size_t& utf8length )
		{
			utf8_bytes = 0;
			const ::booldog::uint16* source = (::booldog::uint16*)&utf16_ptr[ srcbyteindex ] , * source_end = (::booldog::uint16*)( &utf16_ptr[ utf16_ptr_count - 1 ] + 1 );
			if( source_end < source )
				source_end = (::booldog::uint16*)SIZE_MAX;
			::booldog::uint8* target = (::booldog::uint8*)&utf8_ptr[ dstbyteindex ] , * target_end = 0;
			if( utf8_ptr )

#ifndef BOO_UTF32_CONSTS_H
#define BOO_UTF32_CONSTS_H
#ifdef HAVE_CONFIG_H
#include <config.h>
#endif
#include "boo_types.h"
namespace booldog
{
	namespace consts
	{
		namespace utf32
		{
			const ::booldog::byte _firstByteMark[7] = { 0x00, 0x00, 0xC0, 0xE0, 0xF0, 0xF8, 0xFC };
			const ::booldog::byte _utf32_to_cp1251_page_from_152_to_187[] = 
			{
			...
			const ::booldog::byte _utf32_to_cp1251_page_from_1025_to_1169[] = 
			{
			...
			const ::booldog::byte _utf32_to_cp1251_page_from_8211_to_8482[] = 
			{
